...
int main()
{
  ...
  int observations = 32985; // number of random ints to be generated
  ...
  double alpha = 4; // shape parameter. Must be >=1. Lower value clusters numbers closer to the min.
  double beta = 300; // scale parameter. Must be >0. Higher values increase range of generated values.

  // YOU SHOULD NOT NEED TO MODIFY BELOW HERE

  std::ofstream fout("test_input001.txt");
  // seed RNG
